...
function Message({message, own, currentUser, conversationId}) {
  
        return (
    <div className={own ? "message own" :'message'}>
        <div className='messageTop'>
            <img className='messageImg'
            src={own? currentUser?.avatar : 'https://img.freepik.com/foto-gratis/retrato-joven-sonriente-gafas_171337-4842.jpg?w=2000' }
            alt='messageImg'
